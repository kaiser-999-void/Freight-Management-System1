...
<div class="p-8">
    ...
    <?php if ($activeTab == 'gap-analysis'): ?>
        <div class="bg-white rounded-lg shadow p-6">
                ...
                <?php foreach ($gaps as $gap): ?>
                    <div class="border border-gray-200 rounded-lg p-6">
                        ...
                        <div class="flex gap-2 mt-4 pt-4 border-t border-gray-200">
                            <button onclick="createDevelopmentPlan(<?php echo $gap['id']; ?>, '<?php echo htmlspecialchars(addslashes($gap['full_name'])); ?>')" class="flex-1 px-3 py-2 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 text-sm font-medium transition-colors">
                                <i class="fas fa-file-alt mr-2"></i>Create Dev Plan
                            </button>
            ...
            <script>
            function createDevelopmentPlan(gapId, employeeName) {
                alert(`Creating development plan for ${employeeName}.\nFeature coming soon: This will generate a personalized training roadmap.`);
            }

            function viewGapDetails(gapId) {
                alert(`Viewing detailed gap analysis for employee ID: ${gapId}.\nFeature coming soon: This will show detailed breakdown of skills.`);
            }
            </script>
        </div>
    <?php endif; ?>
